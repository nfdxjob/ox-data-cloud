...
public class MassageController {
    ...
    @ApiOperation("所有数据")
    @GetMapping("/all")
    public ResponseEntity<List<Massage>> list() {
        log.info("所有数据");
    ...
    @ApiOperation("列表查询")
    @GetMapping("/list")
    public ResponseEntity<PageData<Massage>> list(PageRequest page, Massage query) {
         log.info("列表查询");
    ...
    @GetMapping("{id}")
    @ApiOperation("根据ID获取")
    public ResponseEntity<Massage> detail(@PathVariable("id") Long massageId) {
    ...
    @PostMapping
    @ApiOperation("创建")
    public ResponseEntity<Massage> create(@RequestBody @Validated Massage massage) {
    ...
    @PutMapping
    @ApiOperation("更新")
    public ResponseEntity<Massage> update(@RequestBody @Validated Massage massage) {
    ...
    @DeleteMapping("/{id}")
    @ApiOperation("根据ID删除")
    public ResponseEntity<Void> deleteById(@PathVariable("id") Long massageId) {
