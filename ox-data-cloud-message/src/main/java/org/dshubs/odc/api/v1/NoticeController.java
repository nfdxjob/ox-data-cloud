...
public class NoticeController {
    ...
    @ApiOperation("列表查询")
    @GetMapping("/list")
    public ResponseEntity<PageData<Notice>> list(PageRequest page, Notice query) {
         log.info("列表查询");
    ...
    @GetMapping("{id}")
    @ApiOperation("根据ID获取")
    public ResponseEntity<Notice> detail(@PathVariable("id") Long noticeId) {
    ...
    @PostMapping
    @ApiOperation("创建")
    public ResponseEntity<Notice> create(@RequestBody @Validated Notice notice) {
    ...
    @PutMapping
    @ApiOperation("更新")
    public ResponseEntity<Notice> update(@RequestBody @Validated Notice notice) {
    ...
    @DeleteMapping("/{id}")
    @ApiOperation("根据ID删除")
    public ResponseEntity<Void> deleteById(@PathVariable("id") Long noticeId) {
