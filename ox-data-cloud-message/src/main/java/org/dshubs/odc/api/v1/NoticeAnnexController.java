 ...
 */
@RestController
@RequestMapping("/api/v1/notice-annexes")
@Api(tags = "公告附件API")
@Slf4j
public class NoticeAnnexController {
    ...
    @ApiOperation("所有数据")
    @GetMapping("/all")
    public ResponseEntity<List<NoticeAnnex>> list() {
        log.info("所有数据");
    ...
    @ApiOperation("列表查询")
    @GetMapping("/list")
    public ResponseEntity<PageData<NoticeAnnex>> list(PageRequest page, NoticeAnnex query) {
         log.info("列表查询");
    ...
    @GetMapping("{id}")
    @ApiOperation("根据ID获取")
    public ResponseEntity<NoticeAnnex> detail(@PathVariable("id") Long noticeAnnexId) {
    ...
    @PostMapping
    @ApiOperation("创建")
    public ResponseEntity<NoticeAnnex> create(@RequestBody @Validated NoticeAnnex noticeAnnex) {
    ...
    @PutMapping
    @ApiOperation("更新")
    public ResponseEntity<NoticeAnnex> update(@RequestBody @Validated NoticeAnnex noticeAnnex) {
    ...
    @DeleteMapping("/{id}")
    @ApiOperation("根据ID删除")
    public ResponseEntity<Void> deleteById(@PathVariable("id") Long noticeAnnexId) {
