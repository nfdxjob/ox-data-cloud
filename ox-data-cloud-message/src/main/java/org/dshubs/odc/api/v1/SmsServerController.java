 ...
 */
@RestController
@RequestMapping("/api/v1/sms-servers")
@Api(tags = "短信服务API")
@Slf4j
public class SmsServerController {
    ...
    @ApiOperation("所有数据")
    @GetMapping("/all")
    public ResponseEntity<List<SmsServer>> list() {
        log.info("所有数据");
    ...
    @ApiOperation("列表查询")
    @GetMapping("/list")
    public ResponseEntity<PageData<SmsServer>> list(PageRequest page, SmsServer query) {
         log.info("列表查询");
    ...
    @GetMapping("{id}")
    @ApiOperation("根据ID获取")
    public ResponseEntity<SmsServer> detail(@PathVariable("id") Long smsServerId) {
    ...
    @PostMapping
    @ApiOperation("创建")
    public ResponseEntity<SmsServer> create(@RequestBody @Validated SmsServer smsServer) {
    ...
    @PutMapping
    @ApiOperation("更新")
    public ResponseEntity<SmsServer> update(@RequestBody @Validated SmsServer smsServer) {
    ...
    @DeleteMapping("/{id}")
    @ApiOperation("根据ID删除")
    public ResponseEntity<Void> deleteById(@PathVariable("id") Long smsServerId) {
