 ...
 */
@RestController
@RequestMapping("/api/v1/{organizationId}/mail-servers")
@Api(tags = "邮件服务API")
@Slf4j
public class MailServerController {
    ...
    @ApiOperation("所有数据")
    @GetMapping("/all")
    public ResponseEntity<List<MailServer>> list(@PathVariable("organizationId") Long organizationId) {
        log.info("所有数据");
    ...
    @ApiOperation("列表查询")
    @GetMapping("/list")
    public ResponseEntity<PageData<MailServer>> list(@PathVariable("organizationId") Long organizationId, PageRequest page, MailServer query) {
        log.info("列表查询");
    ...
    @GetMapping("{id}")
    @ApiOperation("根据ID获取")
    public ResponseEntity<MailServer> detail(@PathVariable("organizationId") Long organizationId, @PathVariable("id") Long mailServerId) {
    ...
    @PostMapping
    @ApiOperation("创建")
    public ResponseEntity<MailServer> create(@PathVariable("organizationId") Long organizationId, @RequestBody @Validated MailServer mailServer) {
    ...
    @PutMapping
    @ApiOperation("更新")
    public ResponseEntity<MailServer> update(@PathVariable("organizationId") Long organizationId, @RequestBody @Validated MailServer mailServer) {
