 ...
 */
@RestController
@RequestMapping("/api/v1/{organizationId}/message-templates")
@Api(tags = "消息模板API")
@Slf4j
public class MessageTemplateController {
    ...
    @ApiOperation("所有数据")
    @GetMapping("/all")
    public ResponseEntity<List<MessageTemplate>> list(@PathVariable("organizationId") Long organizationId) {
        log.info("所有数据");
    ...
    @ApiOperation("列表查询")
    @GetMapping("/list")
    public ResponseEntity<PageData<MessageTemplate>> list(@PathVariable("organizationId") Long organizationId, PageRequest page, MessageTemplate query) {
        log.info("列表查询");
    ...
    @GetMapping("{id}")
    @ApiOperation("根据ID获取")
    public ResponseEntity<MessageTemplate> detail(@PathVariable("organizationId") Long organizationId, @PathVariable("id") Long messageTemplateId) {
    ...
    @PostMapping
    @ApiOperation("创建")
    public ResponseEntity<MessageTemplate> create(@PathVariable("organizationId") Long organizationId, @RequestBody @Validated MessageTemplate messageTemplate) {
    ...
    @PutMapping
    @ApiOperation("更新")
    public ResponseEntity<MessageTemplate> update(@PathVariable("organizationId") Long organizationId, @RequestBody @Validated MessageTemplate messageTemplate) {
    ...
    @DeleteMapping("/{id}")
    @ApiOperation("根据ID删除")
    public ResponseEntity<Void> deleteById(@PathVariable("organizationId") Long organizationId, @PathVariable("id") Long messageTemplateId) {
