...
public class CommonUtil {
    ...
    public static void isEmptyObject(Object object, String message) throws Exception {
    ...
    public static void isEmptyStr(String str, String message) throws Exception {
        if (isEmptyStr(str)) {
            throw new Exception(message);
        }
    }

    public static void isEmptyMapWithKey(Map<String, Object> map, String key, String message) throws Exception {
    ...
    public static void isEmptyAfterTrim(String str, String message) throws Exception {
