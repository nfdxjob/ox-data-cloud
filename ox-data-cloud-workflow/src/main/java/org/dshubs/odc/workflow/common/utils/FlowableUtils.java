...
//        currentUser.setId(SecurityUtils.getUsername());
//        currentUser.setFirstName(SecurityUtils.getNickName());
//        currentUser.setLastName(SecurityUtils.getNickName());
//        currentUser.setDisplayName(SecurityUtils.getNickName());
        return currentUser;
    }
