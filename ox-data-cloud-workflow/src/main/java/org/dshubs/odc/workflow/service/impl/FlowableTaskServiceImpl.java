...
import org.dshubs.odc.workflow.common.cmd.BackUserTaskCmd;
import org.dshubs.odc.workflow.common.cmd.CompleteTaskReadCmd;
import org.dshubs.odc.workflow.common.constant.FlowableConstant;
import org.dshubs.odc.workflow.common.enums.ButtonsEnum;
import org.dshubs.odc.workflow.common.exception.FlowableNoPermissionException;
...
public class FlowableTaskServiceImpl implements FlowableTaskService {
    ...
    public void completeTask(TaskRequest taskRequest) {
        String taskId = taskRequest.getTaskId();
        String currUserId = Objects.requireNonNull(SecurityUtils.getUserId()).toString();
        Task task = getTaskNotNull(taskId);
    ...
    public List<FlowNodeResponse> getBackNodes(String taskId) {
        TaskEntity taskEntity = (TaskEntity) permissionService.validateExcutePermissionOnTask(taskId,
                Objects.requireNonNull(SecurityUtils.getUserId()).toString());
